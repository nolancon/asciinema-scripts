...
screen3()
{
  ...
  command "kubectl exec -it $SRC_POD -n storageos -- bash -c \"mkdir -p /mnt/test ; wget -O /mnt/test/ondat_clone_demo https://speed.hetzner.de/1GB.bin  ; sync /mnt/test/ondat_clone_demo\"" 500
...
screen6(){
  ...
  command "kubectl exec -it $CLONE_POD -n storageos -- bash -c \"ls -l /mnt/test/\"" 100
}
